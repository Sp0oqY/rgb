...
REM
REM Generated by Vivado on Wed Apr 22 00:20:11 +0200 2026
...
echo "xvhdl --incr --relax -prj cfg_tb_rgb_mood_lamp_top_vhdl.prj"
call xvhdl  --incr --relax -prj cfg_tb_rgb_mood_lamp_top_vhdl.prj -log xvhdl.log
