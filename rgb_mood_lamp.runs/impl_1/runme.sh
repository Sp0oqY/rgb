...
HD_PWD='C:/Users/vikto/rgb_mood_lamp/rgb_mood_lamp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb_mood_lamp_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rgb_mood_lamp_top.tcl -notrace
