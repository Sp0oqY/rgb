...
HD_PWD='C:/Users/vikto/rgb_mood_lamp/rgb_mood_lamp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb_mood_lamp_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rgb_mood_lamp_top.tcl
